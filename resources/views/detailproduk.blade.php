        ...
        <div class="row gy-3">
            <div class="col-lg-4">
                <a href="product-grid-right.html" class="card mb-3 card-animate stretched-link">
                    <div class="row g-0">
                        <div class="col-sm-4">
                            <img src="../assets/images/ecommerce/img-5.jpg" class="img-fluid rounded-start h-100 object-fit-cover" alt="...">
                        </div>
                        <div class="col-sm-8">
            ...
            <div class="col-lg-4">
                <a href="product-grid-right.html" class="card mb-3 card-animate stretched-link">
                    <div class="row g-0">
                        <div class="col-sm-4">
                            <img src="../assets/images/ecommerce/img-2.jpg" class="img-fluid rounded-start h-100 object-fit-cover" alt="...">
                        </div>
                        <div class="col-sm-8">
                            <div class="card-body h-100 d-flex flex-column">
            ...
            <div class="col-lg-4">
                <a href="product-grid-right.html" class="card mb-3 card-animate stretched-link">
                    <div class="row g-0">
                        <div class="col-sm-4">
                            <img src="../assets/images/ecommerce/img-3.jpg" class="img-fluid rounded-start h-100 object-fit-cover" alt="...">
                        </div>
                        <div class="col-sm-8">
                            <div class="card-body h-100 d-flex flex-column">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="d-flex align-items-center justify-content-between mb-4 pb-1">
                    ...
                    <div class="flex-shrink-0">
                        <a href="product-grid-defualt.html" class="link-effect link-secondary">All Products <i class="ri-arrow-right-line ms-1 align-bottom"></i></a>
                    </div>
                </div>
            </div><!--end col-->
        </div><!--end row-->
                ...
                <div class="card ecommerce-product-widgets border-0 rounded-0 shadow-none overflow-hidden card-animate">
                    ...
                    <div class="pt-4">
                        <ul class="clothe-colors list-unstyled hstack gap-1 mb-3 flex-wrap">
                            ...
                            <li><input type="radio" name="sizes11" id="product-color-113"><label class="avatar-xxs btn btn-info p-0 d-flex align-items-center justify-content-center rounded-circle" for="product-color-113"></label></li>
                        </ul>
                        <a href="product-details.html">
