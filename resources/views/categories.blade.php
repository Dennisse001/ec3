...
<section class="section ecommerce-about" style="background-image: url('../assets/images/profile-bg.jpg'); background-size: cover; background-position: center;">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6">
                <div class="card card-animate text-center">
                    <div class="card-body p-4">
                        <img src="../assets/images/products/img-5.png" alt="" class="avatar-xl">
                        <div class="mt-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-animate text-center">
                    <div class="card-body p-4">
                        <img src="../assets/images/products/img-16.png" alt="" class="avatar-xl">
                        <div class="mt-4">
                            <a href="product-list-defualt.html" class="stretched-link">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-animate text-center">
                    <div class="card-body p-4">
                        <img src="../assets/images/products/img-8.png" alt="" class="avatar-xl">
                        <div class="mt-4">
                            <a href="product-list-defualt.html" class="stretched-link">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-animate text-center">
                    <div class="card-body p-4">
                        <img src="../assets/images/products/img-11.png" alt="" class="avatar-xl">
                        <div class="mt-4">
                            <a href="product-list-defualt.html" class="stretched-link">
        ...
        <div class="row gy-4">
            ...
            <div class="col-xxl-4 col-md-4">
                <a href="product-list-defualt.html" class="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden position-relative d-block right">
                    <img src="../assets/images/ecommerce/features/img-2.jpg" class="img-fluid rounded" alt="">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-6">
                <div class="text-center">
                    <img src="../assets/images/products/img-6.png" alt="" class="img-fluid rounded-circle bg-warning-subtle border border-2 border-warning border-opacity-10 p-4">
                    <div class="mt-4">
                        <a href="#!">
            ...
            <div class="col-lg-2 col-md-3 col-sm-6">
                <div class="text-center">
                    <img src="../assets/images/products/img-20.png" alt="" class="img-fluid rounded-circle bg-dark-subtle border border-2 border-dark border-opacity-10 p-4">
                    <div class="mt-4">
                        <a href="#!">
            ...
            <div class="col-lg-2 col-md-3 col-sm-6">
                <div class="text-center">
                    <img src="../assets/images/products/img-18.png" alt="" class="img-fluid rounded-circle bg-warning-subtle border border-2 border-warning border-opacity-10 p-4">
                    <div class="mt-4">
                        <a href="#!">
            ...
            <div class="col-lg-2 col-md-3 col-sm-6">
                <div class="text-center">
                    <img src="../assets/images/products/img-1.png" alt="" class="img-fluid rounded-circle bg-danger-subtle border border-2 border-danger border-opacity-10 p-4">
                    <div class="mt-4">
                        <a href="#!">
            ...
            <div class="col-lg-2 col-md-3 col-sm-6">
                <div class="text-center">
                    <img src="../assets/images/products/img-15.png" alt="" class="img-fluid rounded-circle bg-info-subtle border border-2 border-info border-opacity-10 p-4">
                    <div class="mt-4">
                        <a href="#!">
            ...
            <div class="col-lg-2 col-md-3 col-sm-6">
                <div class="text-center">
                    <img src="../assets/images/products/img-5.png" alt="" class="img-fluid rounded-circle bg-danger-subtle border border-2 border-danger border-opacity-10 p-4">
                    <div class="mt-4">
                        <a href="#!">
                    ...
                    <div class="swiper-wrapper py-4">
                            ...
                            <div class="card card-animate overflow-hidden">
                                <div class="bg-dark-subtle rounded-top py-4">
                                    <div class="gallery-product">
                                        <img src="../assets/images/products/img-15.png" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card card-animate overflow-hidden">
                                <div class="bg-dark-subtle rounded-top py-4">
                                    <div class="gallery-product">
                                        <img src="../assets/images/products/img-17.png" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                    </div>
                                </div>
                                <div class="card-body text-center">
                                    <a href="product-list.html" class="stretched-link">
                        ...
                        <div class="swiper-slide">
                            <div class="card card-animate overflow-hidden">
                                <div class="bg-warning-subtle rounded-top py-4">
                                    <div class="gallery-product">
                                        <img src="../assets/images/products/img-18.png" alt="" style="max-height: 215px;max-width: 100%;" class="mx-auto d-block">
                                    </div>
                                </div>
                                <div class="card-body text-center">
                                    <a href="product-list.html" class="stretched-link">
        ...
        <div class="row g-2">
            <div class="col-lg-7">
                <div class="card card-height-100">
                    <a href="product-list-defualt.html" class="insta-img categrory-box rounded-3">
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-0">
                            <a href="product-list-defualt.html" class="insta-img categrory-box rounded-3">
                                ...
                                <img src="../assets/images/ecommerce/instagram/img-2.jpg" class="w-100 object-fit-cover" alt="" style="max-height: 318px;">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="card mb-0">
                            <a href="product-list-defualt.html" class="insta-img categrory-box rounded-3">
                                ...
                                <img src="../assets/images/ecommerce/instagram/img-5.jpg" class="w-100 object-fit-cover" alt="" style="max-height: 318px;">
                            </a>
                        </div>
                    </div>
                </div>
