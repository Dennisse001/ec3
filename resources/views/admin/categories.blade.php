            ...
            <div class="row">
                <div class="col-xxl-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form  method="POST" action="{{ route('createcat') }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation createCategory-form" id="createCategory-form" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-xxl-12 col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="categoryTitle" placeholder="Enter title" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative d-inline-block">
                                                <div class="position-absolute top-100 start-100 translate-middle">
                                                    ...
                                                    <input class="form-control d-none" id="category-image-input" type="file" accept="image/png, image/gif, image/jpeg">
                                                </div>
                                                <div class="avatar-lg">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="btn-close" id="close-removecategoryModal" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body p-md-5">
                        ...
                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                            ...
                            <button type="button" class="btn w-sm btn-danger btn-hover" id="remove-category">Yes, Delete It!</button>
                        </div>
                    </div>
