...
<!-- Mirrored from themesbrand.com/toner/html/backend/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Sep 2023 04:56:07 GMT -->
<head>

        <meta charset="utf-8">
        <title>Admin Sual Ku</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="eCommerce + Admin HTML Template" name="description">
        <meta content="Themesbrand" name="author">
        <!-- App favicon -->
        <link rel="shortcut icon" href="../assets/images/logo-l.png">
        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-4 col-6 d-none d-xxl-block">
                <div class="d-flex align-items-center justify-content-center gap-3 fs-14 fw-medium">
                    <div>
                        <i class="bi bi-envelope align-middle me-2"></i> kelompok3@yahoo.com
                    </div>
                    <div>
                        <i class="bi bi-globe align-middle me-2"></i> www.sualku.com
                    </div>
                </div>
            </div>
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown ms-sm-3 header-item topbar-user topbar-head-dropdown dropdown-hover-end">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <!-- item-->
                                    <h6 class="dropdown-header">Welcome @if(Auth::check())
                                        {{ Auth::user()->nama_depan }}
                                     @endif!</h6>
                                    <a class="dropdown-item" href="{{ route('profile.admin') }}"><i class="bi bi-person-circle text-muted fs-15 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                                    ...
                                    <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                     ...
                                     <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>                                    <a class="dropdown-item" href="/"><i class="bi bi-box-arrow-in-left text-muted fs-15 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Kembali</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div data-simplebar class="h-100">
                    <div class="p-4">
                        ...
                        <div class="mb-4 hstack gap-2">
                            <a href="../frontend/index-2.html" target="_blank" class="btn btn-secondary">Visit Your Website</a>
    ...
    <script src="../assets/libs/wnumb/wNumb.min.js"></script>
        ...
        <script src="../../../assets/libs/list.js/list.min.html"></script>

        <!--Swiper slider js-->
        <script src="../assets/libs/swiper/swiper-bundle.min.js"></script>

        <script src="../assets/js/backend/product-grid.init.js"></script>
  ...
  <!--Account init js-->
  <script src="../assets/js/backend/account.init.js"></script>
        <!-- Dashboard init -->
        ...
        <script src="../assets/js/backend/product-categories.init.js"></script>
...
<!-- Mirrored from themesbrand.com/toner/html/backend/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Sep 2023 04:56:18 GMT -->
</html>
