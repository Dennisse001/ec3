                            ...
                            <div class="col-sm-auto">
                                <div class="avatar-lg h-100">
                                    <div class="avatar-title bg-secondary-subtle rounded py-3">
                                        <img src="../assets/images/products/img-15.png" alt="" class="avatar-md">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm">
                            ...
                            <div class="col-sm-auto">
                                <div class="avatar-lg h-100">
                                    <div class="avatar-title bg-warning-subtle rounded py-3">
                                        <img src="../assets/images/products/img-6.png" alt="" class="avatar-md">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm">
                            ...
                            <div class="col-sm-auto">
                                <div class="avatar-lg h-100">
                                    <div class="avatar-title bg-dark-subtle rounded py-3">
                                        <img src="../assets/images/products/img-9.png" alt="" class="avatar-md">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm">
